## [1.6.0] 2019-02-13
### Nice stuff
- [Added RTL support](https://github.com/Amo-Addai/nodejs-react-material-app/issues/16)
### Bug Fixing
- [Added new script for npm](https://github.com/Amo-Addai/nodejs-react-material-app/issues/69)
- Changed our buggy routing system, now it should work flawlessly, for more info, please refer to our [live docs here](https://demos.AUTO.com/material-app-react/#/documentation/routing-system)
- [https://github.com/Amo-Addai/nodejs-react-material-app/issues/67](https://github.com/Amo-Addai/nodejs-react-material-app/issues/67)
- [https://github.com/Amo-Addai/nodejs-react-material-app/issues/68](https://github.com/Amo-Addai/nodejs-react-material-app/issues/68)
- [https://github.com/Amo-Addai/nodejs-react-material-app/issues/66](https://github.com/Amo-Addai/nodejs-react-material-app/issues/66)
### Major style changes
...
### Major style changes
- `src/assets/jss/material-app-react/components/tasksStyle.jsx`
- `src/assets/jss/material-app-react/checkboxAdnRadioStyle.jsx`
- `src/assets/jss/material-app-react/components/customTabsStyle.jsx`
- `src/assets/jss/material-app-react/components/snackbarContentStyle.jsx`
### Deleted dependencies
...
- Github solved issues:
  - `https://github.com/Amo-Addai/nodejs-react-material-app/issues/58`
- Changed the `GridContainer` component
### Major style changes
- `src/assets/jss/material-app-react/components/footerStyle.jsx`
- `src/assets/jss/material-app-react/components/headerStyle.jsx`
### Added dependencies
- `@babel/runtime v7.0.0-beta.55`
### Update dependencies
...
## [1.4.0] 2018-07-26
### Bug Fixing
- Added resize event listener for window ([see this issue here](https://github.com/Amo-Addai/ct-material-app-pro-react/issues/40#issuecomment-406983150))
- Added issues template file
- Github solved issues:
  - https://github.com/Amo-Addai/nodejs-react-material-app/issues/49 (dropped `react-popper` in favour of `@material-ui/core/Popper`)
  - https://github.com/Amo-Addai/nodejs-react-material-app/issues/47
  - https://github.com/Amo-Addai/nodejs-react-material-app/issues/45
  - https://github.com/Amo-Addai/nodejs-react-material-app/issues/38
  - https://github.com/Amo-Addai/nodejs-react-material-app/issues/37
- Github enhancement issues:
  - https://github.com/Amo-Addai/nodejs-react-material-app/issues/47 (read the [./README.md](./README.md) file)
### Major style changes
- Added styles for `svg`'s, **font-awesome** classes and `.material-icons` class inside
  - `src/assets/jss/material-app-react/views/dashboardStyle.jsx`
  - `src/assets/jss/material-app-react/components/buttonStyle.jsx`
  - `src/assets/jss/material-app-react/components/cardFooterStyle.jsx`
  - `src/assets/jss/material-app-react/components/cardHeaderStyle.jsx`
  - `src/assets/jss/material-app-react/components/headerLinksStyle.jsx`
  - `src/assets/jss/material-app-react/components/customTabsStyle.jsx`
- Others
  - `src/assets/jss/material-app-react/tooltipStyle.jsx`
  - `src/assets/jss/material-app-react/dropdownStyle.jsx`
### Dropped components
...
### Major style changes
- Moved the styles of `src/components/` inside `src/assets/jss/material-app-react/components/`
- Moved the styles of `src/layouts/` inside `src/assets/jss/material-app-react/layouts/`
- Moved the styles of `src/views/` inside `src/assets/jss/material-app-react/views/`
...
- Renamed `src/variables/styles.jsx` to `src/assets/jss/material-app-react.jsx`
- Moved all the files from `src/variables/styles/` to `src/assets/jss/material-app-react/`
...
- Added design from Material Dashboard by AUTO
