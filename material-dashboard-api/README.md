...
2. [Clone the project from github](https://github.com/Amo-Addai/nodejs-react-material-app) or [download the archive](https://github.com/Amo-Addai/nodejs-react-material-app)
3. Go into Node.js API directory: `cd nodejs-react-material-app/material-dashboard-api`
...
```bash
DATABASE_URL=http://AUTO:AUTO@127.0.0.1:5432/AUTO
